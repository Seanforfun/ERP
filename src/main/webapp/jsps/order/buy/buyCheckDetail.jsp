	...
	<div class="content-text">
			<div class="square-o-top">
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						...
						<td>下 单 人:</td>
						<td class="order_show_msg">${om.creator.name}</td>
						<td>订 单 号:</td>
			...
			<div class="square-order">
				...
				<table width="100%">
					<tr align="center">
						<td width="50%">
							<s:a action="order_buyCheckPass.action" cssStyle="color:#0f0;font-size:20px;padding-top:2px;font-weight:bold;text-decoration:none;width:82px;height:28px;display:block;background:url(images/btn_bg.jpg)">
								<s:param name="om.uuid" value="om.uuid"/>
								通&nbsp;&nbsp;过
							</s:a>
						</td>
						<td width="50%">
							<s:a action="order_buyCheckReject.action" cssStyle="color:#f00;font-size:20px;padding-top:2px;font-weight:bold;text-decoration:none;width:82px;height:28px;display:block;background:url(images/btn_bg.jpg)">
								<s:param name="om.uuid" value="om.uuid"/>
								驳&nbsp;&nbsp;回
							</s:a>
						</td>
