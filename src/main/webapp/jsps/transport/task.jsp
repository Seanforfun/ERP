			...
			<div class="square-o-top">
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						...
						<td>联系方式:</td>
						<td class="order_show_msg">${om.sm.phone }</td>
						<td>商品总量:</td>
			...
			<div class="square-order">
				...
				<table width="100%">
					<tr>
						...
						<s:if test="om.type == @ca.mcmaster.erp.invoice.order.model.OrderModel@ORDER_TYPE_OF_BUY_BUYING">
							<s:a action="transport_endTask.action" style="color:#0f0;font-size:20px;padding-top:2px;font-weight:bold;text-decoration:none;width:82px;height:28px;display:block;background:url(images/btn_bg.jpg)">
								<s:param name="om.uuid" value="om.uuid"/>
								结&nbsp;&nbsp;单
							</s:a>
						</s:if>
						<s:elseif test="om.type == @ca.mcmaster.erp.invoice.order.model.OrderModel@ORDER_TYPE_OF_BUY_IN_STORE">
